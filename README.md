...
urls_*.txt - Tester files with lots of URLs to test through POSTMAN
convert.py - Converted files to lists to pass in through POSTMAN
swagger.json - API definition for this exercise
project/main.go - My main code
restapi/configure_simple_web_scrape.go - Handler for the API to work

The rest - Auto generated by Swagger mostly
